...
export const EditorData = () => (
  <div>
    <h3>
      Niyo Bootcamp is a specialized training program designed to enhance
      software engineering and coding skills through a comprehensive curriculum
      that includes programming languages, software development methodologies,
      data structures, and algorithms. The bootcamp places a strong emphasis on
      hands-on projects, enabling participants to gain practical experience by
      tackling real-world scenarios, thereby applying theoretical knowledge in a
      practical context. Led by industry experts, Niyo Bootcamp offers valuable
      insights and mentorship, guiding participants through the complexities of
      software engineering. <br /> <br /> The collaborative learning environment
      encourages teamwork, mirroring the collaborative nature of the software
      industry, and helping participants develop essential team-working skills.
      Career support services such as resume building, interview preparation,
      and networking opportunities further aid participants in transitioning
      into or advancing within the software engineering field. Participants
      benefit significantly by acquiring new skills, deepening their existing
      knowledge, and gaining confidence in their coding abilities. Networking
      opportunities provided by the bootcamp allow participants to connect with
      peers, instructors, and industry professionals, leading to potential job
      opportunities, collaborations, and mentorship. Enhanced skills and
      practical experience gained from the bootcamp position participants better
      for career advancement, whether through new job opportunities or
      promotions in their current roles.
      <br /> <br />
      Personally, attending Niyo Bootcamp transforms one's approach to coding
      and software engineering, fostering improved problem-solving and critical
      thinking skills, keeping participants updated with the latest
      technologies, and enabling them to build a strong portfolio that showcases
      their capabilities to potential employers.
      <br /> <br /> Overall, Niyo Bootcamp equips participants with the skills,
      experience, and confidence necessary to excel in the field of software
